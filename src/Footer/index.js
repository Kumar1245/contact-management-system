    ...
    <>
      {/* <div className=" grid lg:grid-cols-3 md:grid-cols-2 gap-3  bg-stone-200 ">
        <div className="flex flex-col p-4 justify-start mx-4">
          <p className="text-lime-500 font-bold">Contact Management App</p>
          <p>Service </p>
          <p>FQY</p>
          <p>Hints</p>
          <p>Support</p>
        ...
        <div className=" flex flex-col p-4 justify-start">
          <p className="text-lime-500 font-bold">Help With Us Zucol Group</p>
          <p>Service </p>
          <p>FQY</p>
          <p>Hints</p>
          <p>Support</p>
      ...
      <div className="fixed bottom-0 w-full lg:flex md:hidden hidden border bg-stone-600 items-center text- justify-center">
        <p className=" flex font-mono text-gray-200 item-center text-center p-2">
          Copyright © 2023-2024 Zucol Group Services Pvt Ltd
        </p>
      </div>
      {/* <div className="grid grid-cols-2 lg:hidden md:hidden bg-stone-400">
        <div className="flex flex-col gap-2 p-3">
          <p className="text-green-800">Contact </p>
      ...
      <div className="fixed bottom-0 w-full lg:hidden md:hidden bg-stone-600">
